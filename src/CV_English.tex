...
%\vspace*{-1cm} 
\section{Education}
\cventry{2015-Now}{PhD in Machine Learning}{CIFRE agreement (Industrial agreement of learning/training by research) between \href{https://www.lri.fr/presentation_en.php}{LRI} lab (\href{https://www.inria.fr/en/}{INRIA}) and \href{http://www.rte-france.com/en}{RTE France} (French Transmission System Operator)}{Paris Area, France}{}{PhD entitled "Machine learning for a efficient and robust conduct of the Power Grid". It aims at applying state of the art machine learning algorithm (including deep learning and reinforcement learning) to better operate the grid in a context of fast growing intermittent renewable energy.}
...
\cventry{}{Natation}{ $\approx$ 3h / week, running and hiking (during vacation)}{}{}{}
